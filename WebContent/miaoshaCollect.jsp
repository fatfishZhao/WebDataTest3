...
<link rel="stylesheet" type="text/css" href="/WebDataTest3/CSS/miao.css" charset="utf-8">
...
<body onload="browerInfo()" onkeydown="keyDown()" onkeyup="keyUp()"  onmousedown="mousedown_sendXML()" onmousemove="mousemove_sendXML()" onmouseup="mouseup_sendXML()">
    ...
    <li class="mp-single-item" data-id="2839496677" data-click="{pn:'1'}" style="bottom: 0px; z-index: 1;">
      <div class="item-info">
        <img data-src="/WebDataTest3/images/tata.jpg" class="item-logo" src="/WebDataTest3/images/tata.jpg" style="display: inline;">    
        <h4 class="item-discount">秒杀价<em>3.8元</em>&nbsp; &nbsp; &nbsp;&nbsp;原价：98元</h4>
        <h4 class="item-stitle">交大纪念品折扣1-5折 京东配货</h4>
        <p class="item-time" id="item-time">离开始: 0小时0分10秒</p>
    ...
    <div class="item-pic">
      <img class="load-bear" src="/WebDataTest3/images/miao.jpg" style="display: inline;"> 
    </div>
...
<script>
 document.write("<s"+"cript type='text/javascript' src='/WebDataTest3/js/miao.js?"+Math.random()+"'></scr"+"ipt>");
